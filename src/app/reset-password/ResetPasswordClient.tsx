...
export default function ResetPasswordClient() {
  ...
  return (
    <div
      className={`min-h-screen bg-black flex items-center justify-center p-4 transition-opacity duration-700 ${
    ...
    >
      ...
      {/* Main container */}
      <div
        className={`w-full max-w-md bg-white/5 backdrop-blur-lg rounded-xl overflow-hidden shadow-2xl border border-white/10 transform transition-all duration-700 ${
      ...
      >
        <div className="p-8">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-white/70 text-sm">Create a new strong password</p>
          </div>
          ...
          {message && (
            <div
              className={`mb-6 p-4 rounded-lg flex items-center ${
                isError ? 'bg-red-500/10 border border-red-500/30 text-red-300' : 'bg-green-500/10 border border-green-500/30 text-green-300'
              }`}
            >
              {isError ? <AlertCircle className="h-5 w-5 mr-2 flex-shrink-0" /> : <CheckCircle className="h-5 w-5 mr-2 flex-shrink-0" />}
